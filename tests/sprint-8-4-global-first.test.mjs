...
test('PWA Service Worker v12 Integrity', async (t) => {
  await t.test('sw.js defines cunfashion-cache-v12', () => {
    ...
    assert.ok(content.includes('cunfashion-cache-v12') || content.includes('cunfashion-cache-v13') || content.includes('cunfashion-cache-v14'), 'Must be upgraded to cache-v12, cache-v13, or cache-v14');
  });
});
