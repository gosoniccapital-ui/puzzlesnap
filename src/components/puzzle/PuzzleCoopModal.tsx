      ...
      <div className="bg-stone-900 border border-stone-800 rounded-3xl p-6 max-w-md w-full space-y-5 shadow-2xl">
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-2.5">
            ...
            <div>
              <h3 className="text-base font-bold text-white">Chơi Cùng Bạn Bè (Co-Op)</h3>
              <p className="text-xs text-stone-400">Ghép hình cùng nhau thời gian thực (2 - 8 người)</p>
            </div>
          </div>
          <button
            onClick={onClose}
        ...
        {isConnected ? (
          <div className="space-y-4">
            <div className="p-3.5 bg-emerald-500/10 border border-emerald-500/20 rounded-2xl flex items-center justify-between">
              <div className="flex items-center gap-2">
                ...
                <span className="text-xs font-bold text-emerald-300">Đang trong phòng: <strong>{roomId}</strong></span>
              </div>
              <button
                onClick={onLeaveRoom}
                className="text-[11px] font-bold text-rose-400 hover:text-rose-300 px-2 py-1 rounded-lg bg-rose-500/10 transition cursor-pointer"
              >
                Rời phòng
              </button>
            </div>
            ...
            <div className="space-y-1.5">
              <label className="text-xs font-semibold text-stone-300">Đường link mời bạn bè:</label>
            ...
            <div className="space-y-2">
              <div className="flex items-center justify-between text-xs text-stone-400">
                <span className="font-semibold">Thành viên trong phòng ({players.length + 1}):</span>
                <span className="text-[10px] text-amber-400">Đồng bộ Live</span>
              </div>
              <div className="space-y-1.5 max-h-40 overflow-y-auto pr-1">
                ...
                <div className="flex items-center justify-between p-2.5 rounded-xl bg-stone-950 border border-stone-800 text-xs">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="font-bold text-stone-200">{localPlayerName} (Bạn)</span>
                  </div>
                  <span className="text-[10px] font-bold px-2 py-0.5 rounded-md bg-amber-500/20 text-amber-300">Chủ phòng</span>
                </div>
                {/* Remote Players */}
                {players.map((p) => (
            ...
            <div className="p-3 bg-amber-500/10 border border-amber-500/20 rounded-xl flex items-center gap-2 text-xs text-amber-200">
              ...
              <span>Gửi link này cho bạn bè. Khi bạn bè mở link sẽ tự động vào chung phòng và cùng ghép mảnh với bạn!</span>
            </div>
          </div>
        ) : (
          ...
          <div className="space-y-4">
            <div className="text-xs text-stone-400 leading-relaxed">
              Bạn có thể tạo phòng mới và gửi link cho bạn bè, hoặc nhập mã phòng của bạn bè để tham gia ghép chung.
            </div>
            ...
            >
              ...
              <span>Tạo Phòng Chơi Mới Ngay</span>
            </button>

            <div className="relative flex py-1 items-center">
              <div className="grow border-t border-stone-800"></div>
              <span className="shrink mx-3 text-stone-600 text-[11px] font-bold">HOẶC NHẬP MÃ PHÒNG</span>
              <div className="grow border-t border-stone-800"></div>
            </div>
