            ...
            {count === 0 ? (
              ...
              filteredItems.map((item) => {
                ...
                return (
                  <div
                    key={item.id}
                    className="p-3 bg-stone-800/50 hover:bg-stone-800/80 border border-stone-755 rounded-2xl transition flex gap-3 group relative"
                  >
                    {/* Thumbnail */}
              ...
              >
                {copied ? (
                  <>
                    ...
                    <span className="text-emerald-400">Outfit list copied!</span>
                  </>
                ) : (
                  <>
